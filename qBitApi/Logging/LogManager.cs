...
namespace qBitApi.Logging
{
    internal class LogManager
    {
        ...
        {
            Level = minSeverity;
            ClientLogger = new Logger(this, "qBitApi");
        }
        ...
        {
            await ClientLogger.InfoAsync($"qBitApi v{qBitApiConfig.Version} (API v{qBitApiConfig.APIVersion})").ConfigureAwait(false);
        }
    }
}