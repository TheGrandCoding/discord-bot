...
namespace DiscordBot.Migrations.BotDb
{
    ...
    [Migration("20230314185659_AddrepPosts")]
    partial class AddrepPosts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscordBot.Classes.PublishPost", b =>
                {
                    ...
                    b.Property<string>("DefaultMediaUrl")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("DiscordBot.Classes.PublishPost", b =>
                {
                    b.OwnsOne("DiscordBot.Classes.PublishDiscord", "Discord", b1 =>
                        {
                            b1.Property<uint>("PublishPostId")
                                .HasColumnType("int unsigned");
                            ...
                            b1.HasKey("PublishPostId");

                            b1.ToTable("Posts");

                            b1.WithOwner()
                                .HasForeignKey("PublishPostId");
                        });

                    b.OwnsOne("DiscordBot.Classes.PublishInstagram", "Instagram", b1 =>
                        {
                            b1.Property<uint>("PublishPostId")
                                .HasColumnType("int unsigned");
